  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-20 md:pb-32">
          ...
          <AnimatePresence mode="wait">
            <motion.div key={slide.id}>
              <motion.p
                ...
                className="text-white/50 mb-6 tracking-[0.3em]"
              ...
              <div className="overflow-hidden">
                <motion.h1
                  ...
                  className="text-white/30 tracking-[-0.03em]"
                  style={{ fontSize: "clamp(3rem, 10vw, 9rem)", fontWeight: 700, lineHeight: 0.95 }}
                >
                  {slide.titleLine2}
                </motion.h1>
        ...
        <div className="absolute bottom-10 right-6 md:right-16 flex items-center gap-4">
          <span className="text-white/40 tabular-nums" style={{ fontSize: "12px" }}>
      ...
      <motion.div
        className="absolute bottom-10 left-6 md:left-16 flex flex-col items-center gap-2"
        animate={{ opacity: [1, 0.3, 1] }}
        transition={{ duration: 2, repeat: Infinity }}
      >
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent to-white/50" />
        <span className="text-white/30 tracking-[0.2em]" style={{ fontSize: "9px" }}>SCROLL</span>
      </motion.div>
    </section>
  );
}