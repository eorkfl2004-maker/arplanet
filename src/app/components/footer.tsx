      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-14 md:py-20">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-8 mb-12">
          ...
          <div className="md:w-1/3">
            ...
            <p className="text-white/20 tracking-[0.05em]" style={{ fontSize: "12px", fontWeight: 300 }}>
              classical music
            </p>
            <p className="text-white/30 mt-3" style={{ fontSize: "13px", lineHeight: 1.8, fontWeight: 300 }}>
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <p className="text-white/40 tracking-[0.2em] mb-4" style={{ fontSize: "10px", fontWeight: 500 }}>
                BUSINESS
              </p>
              <ul className="space-y-2">
                {["공연 기획", "아티스트 육성", "브랜딩 지원", "ARTFLOH"].map((l) => (
                  <li key={l}>
                    <a href="#services" className="text-white/20 hover:text-white/50 transition-colors duration-500" style={{ fontSize: "13px", fontWeight: 300 }}>
                      {l}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={l.label}>
                    <a href={l.href} target="_blank" rel="noopener noreferrer" className="text-white/20 hover:text-white/50 transition-colors duration-500" style={{ fontSize: "13px", fontWeight: 300 }}>
                      {l.label}
                    </a>
                  </li>
                ))}
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="space-y-1.5 text-white/20" style={{ fontSize: "13px", fontWeight: 300 }}>
                <p>대표이사: 최혜지</p>
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-6 items-center">
            <Link to="/terms" className="text-white/15 hover:text-white/40 transition-colors duration-500" style={{ fontSize: "11px", fontWeight: 300 }}>
              이용약관
            </Link>
            <Link to="/privacy" className="text-white/15 hover:text-white/40 transition-colors duration-500" style={{ fontSize: "11px", fontWeight: 300 }}>
              개인정보처리방침
            </Link>
            <Link
              to="/login"
