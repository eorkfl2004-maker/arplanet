...
export function AwardsSection() {
  ...
  return (
    <section id="awards" className="bg-black py-20 md:py-28 border-t border-white/[0.06]" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div>
          {sortedAwards.map((award, i) => (
            ...
            >
              <div className="py-6 md:py-8 flex flex-col md:flex-row md:items-center gap-2 md:gap-0">
                <div className="flex items-center gap-4 md:w-40 shrink-0">
                  <Award size={14} className="text-white/15 hidden md:block" />
                  <span className="text-white/35 tabular-nums" style={{ fontSize: "14px", fontWeight: 400 }}>
                    {award.year}
                  </span>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/35 mt-1" style={{ fontSize: "13px", fontWeight: 300 }}>
                    {award.organizer}
                  </p>
                  {award.desc && (
                    <p
