...
export function PortfolioSection() {
  ...
  return (
    <section id="portfolio" className="bg-[#0a0a0a] py-16 md:py-28" ref={ref}>
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-3 md:p-6">
                      <div className="flex justify-between items-start">
                        <span className="text-white/50 md:text-white/0 md:group-hover:text-white/50 transition-all duration-500 tracking-[0.1em]" style={{ fontSize: "9px" }}>
                          {project.client}
                        </span>
                      ...
                      <div className="md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-700">
                        <p className="text-white/40 md:text-white/0 md:group-hover:text-white/40 transition-all duration-500 tracking-[0.1em] mb-1" style={{ fontSize: "9px" }}>
                        ...
                        {project.desc && (
                          <p className="text-white/35 md:text-white/0 md:group-hover:text-white/35 transition-all duration-500 mt-1 hidden md:block" style={{ fontSize: "12px", fontWeight: 300 }}>
                            {project.desc}
                          </p>
                        )}
                      </div>
        ...
        {filtered.length > 0 && (
          ...
          >
            <Link
              to="/portfolio"
              className="px-8 py-3 border border-white/[0.08] text-white/30 hover:text-white hover:border-white/20 transition-all tracking-[0.1em]"
